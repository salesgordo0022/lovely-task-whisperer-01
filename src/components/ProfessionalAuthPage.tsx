...
import { Loader2, Mail, Lock, Target, TrendingUp, BarChart3 } from 'lucide-react';
...
export function ProfessionalAuthPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: 'Erro', description: 'Erro inesperado no cadastro', variant: 'destructive' });
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: 'Erro', description: 'Erro inesperado no login', variant: 'destructive' });
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-center items-center p-12 text-primary-foreground text-center">
          ...
          <div className="space-y-8 max-w-md macos-slide-up">
            <div>
              <h2 className="text-2xl font-semibold mb-4">Organize suas tarefas com inteligência</h2>
                ...
                <>
                  <Tabs defaultValue="signin" className="w-full">
                    <TabsList className="grid w-full grid-cols-2 mb-6">
                      <TabsTrigger value="signin" className="text-sm font-medium">Entrar</TabsTrigger>
                    ...
                    <TabsContent value="signin" className="space-y-4">
                      <form onSubmit={handleSignIn} className="space-y-4">
                        <div className="space-y-4">
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              ...
                              <Input id="email" type="email" placeholder="seu@email.com" value={email} onChange={(e) => setEmail(e.target.value)} className="pl-10 h-12" required />
                            </div>
                          </div>
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              ...
                              <Input id="password" type="password" placeholder="Digite sua senha" value={password} onChange={(e) => setPassword(e.target.value)} className="pl-10 h-12" required />
                            </div>
                          </div>
                        </div>
                        ...
                        <Button type="submit" className="w-full h-12 text-base font-medium macos-button" disabled={loading}>
                      ...
                      <form onSubmit={handleSignUp} className="space-y-4">
                        <div className="space-y-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              <Lock className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                              <Input id="signup-password" type="password" placeholder="Mínimo 6 caracteres" value={password} onChange={(e) => setPassword(e.target.value)} className="pl-10 h-12" required minLength={6} />
                            </div>
                          </div>
                        </div>
                        <Button type="submit" className="w-full h-12 text-base font-medium macos-button" disabled={loading}>
